...
import static com.google.common.collect.Cut.belowAll;
...
public final class Range<C extends Comparable> implements Predicate<C>, Serializable {
  ...
  private static final Range<Comparable> ALL =
      new Range<Comparable>(belowAll(), Cut.aboveAll());
  ...
  private Range(Cut<C> lowerBound, Cut<C> upperBound) {
    ...
    if(lowerBound instanceof Cut.BelowAll){
      lowerBound = Cut.belowAll();
    }

    if(upperBound instanceof Cut.AboveAll){
