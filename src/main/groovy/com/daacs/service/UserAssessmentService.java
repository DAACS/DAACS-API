...
public interface UserAssessmentService {
    ...
    Try<List<UserAssessmentSummary>> getSummaries(String userId, AssessmentCategory assessmentCategory, Instant takenDate);
    ...
    Try<List<UserAssessmentTakenDate>> getTakenDates(String userId, AssessmentCategory assessmentCategory);
    ...
    Try<UserAssessmentSummary> getLatestSummary(String userId, AssessmentCategory assessmentCategory);
    Try<UserAssessment> getUserAssesment(String userId, String userAssessmentId);
