...
class ScoringServiceSpec extends Specification {
    ...
    def setup(){
        ...
        scoringService = new ScoringServiceImpl(userAssessmentRepository: userAssessmentRepository, assessmentRepository: assessmentRepository, graderFactory: graderFactory)
